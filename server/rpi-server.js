...
function RO_action(actionName) {
    if (actionName == "RO_wake_up") {
        ...
        console.log("wait");
        var player = omx("../data/RO_wait.mp4", true);
    } else if (actionName == "RO_OK") {
        console.log("OK");
        var player = omx("../data/RO_OK.mp4", true);
        setTimeout(player.pause(), 1000);
    } else if (actionName == "RO_sleep") {
        console.log("sleep");
        var player = omx("../data/RO_sleep.mp4", true);
        setTimeout(player.pause(), 2000);
        //servo
    } else if (actionName == "RO_move_out") {
        console.log("move out");
        var player = omx("../data/RO_move_out.mp4", true);
        setTimeout(() => {
            //servo
            var player = omx("../data/RO_sleep.mp4", true);
            setTimeout(player.pause(), 2000);
        ...
        //servo
        setTimeout(() => {
            var player = omx("../data/RO_move_in.mp4", true);
            setTimeout(player.pause(), 3000);
        }, 2000);
    } else if (actionName == "RO_play(RE)") {
        console.log("play(RE)")
        var player = omx("../data/RO_play(RE).mp4", true);
        setTimeout(player.pause(), 3000);
    } else if (actionName == "RO_superpower") {
        console.log("superpower")
        var player = omx("../data/RO_superpower.mp4", true);
        setTimeout(player.pause(), 3000);
    } else if (actionName == "RO_play(CT)") {
        console.log("play(CT)")
        var player = omx("../data/RO_play(CT).mp4", true);
        setTimeout(player.pause(), 3000);
    } else if (actionName == "RO_communicate") {
        console.log("communicate")
        var player = omx("../data/RO_communicate.mp4", true);
        setTimeout(player.pause(), 3000);
    } else if (actionName == "RO_play(R)") {
        console.log("play(R)")
        var player = omx("../data/RO_play(R).mp4", true);
        setTimeout(player.pause(), 3000);
    } else if (actionName == "RO_play(CVST)") {
        console.log("play(CVST)")
        var player = omx("../data/RO_play(CVST).mp4", true);
        setTimeout(player.pause(), 3000);
        ...
        setTimeout(() => {
            player.quit();
            //servo
            var player = omx("../data/black.mp4", true);
            player.pause();
        }, 3000);
    } else {
        console.log("Error !");
